About libiconv-split-feedstock
==============================
...
Package license: GPL-3.0 and LGPL-2.1

Summary: Splitted feedstock providing iconv for systems which don't have one (or that cannot convert from/to Unicode.)
